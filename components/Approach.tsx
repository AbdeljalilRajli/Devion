    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
          ...
          description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse volutpat ipsum ipsum, sed ornare massa auctor id. Suspendisse lacinia gravida tellus eget mattis."
          >
          <CanvasRevealEffect
            animationSpeed={5.1}
